...
// scripts/local_saves/cloud_sync_version_bypass_bridge_RVA.ts
var require_cloud_sync_version_bypass_bridge_RVA = __commonJS({
  "scripts/local_saves/cloud_sync_version_bypass_bridge_RVA.ts"(exports) {
    init_node_globals();
    Object.defineProperty(exports, "__esModule", { value: true });
    init_dist();
    var TARGET_MODULE = "libil2cpp.so";
    var SYNC_COMPARE_SAVE_BRANCH_RVA = 32767768;
    var SYNC_COMPARE_GAME_BRANCH_RVA = 32767784;
    var SYNC_NORMAL_PATH_RVA = 32771204;
    ...
    function patchBranch(address, target) {
      Memory.patchCode(address, 4, (code) => {
        const writer = new Arm64Writer(code, { pc: address });
    ...
    function installSyncVersionBypass(baseAddress) {
    ...
    Il2Cpp.perform(() => {
      assertArm64();
      const module2 = Process.findModuleByName(TARGET_MODULE);
      if (!module2) {
        throw new Error(`${TARGET_MODULE} not found`);
      }
      installSyncVersionBypass(module2.base);
...
require_cloud_sync_version_bypass_bridge_RVA();
