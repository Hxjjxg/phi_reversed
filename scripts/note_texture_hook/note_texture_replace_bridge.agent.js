...
// note_texture_replace_bridge.ts
var require_note_texture_replace_bridge = __commonJS({
  "note_texture_replace_bridge.ts"(exports) {
    init_node_globals();
...
require_note_texture_replace_bridge();
