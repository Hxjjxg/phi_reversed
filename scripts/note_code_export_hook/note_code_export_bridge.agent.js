...
// scripts/note_code_export_hook/note_code_export_bridge.ts
var require_note_code_export_bridge = __commonJS({
  "scripts/note_code_export_hook/note_code_export_bridge.ts"(exports) {
    init_node_globals();
    ...
    function exportNoteCodes(scoreControl) {
...
require_note_code_export_bridge();
